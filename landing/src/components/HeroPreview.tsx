export function HeroPreview() {
  return (
    <div className="hero-preview relative mx-auto w-full max-w-[31rem]" role="img" aria-label="Vista previa del cálculo de DoBre">
      ...
      <div className="relative overflow-hidden rounded-[2rem] border border-line bg-surface/80 p-3 shadow-[0_30px_80px_rgba(15,23,42,0.18)] backdrop-blur-xl">
        <div className="flex items-center justify-between px-2 pb-4 pt-1">
          ...
          <span className="rounded-full bg-teal-soft px-2.5 py-1 text-[0.66rem] font-bold text-teal">Modo normal</span>
        </div>
        <div className="rounded-[1.45rem] border border-line bg-surface p-5">
          <p className="text-xs font-semibold uppercase tracking-[0.16em] text-muted">Quiero recibir</p>
          <p className="mt-2 text-3xl font-extrabold tracking-[-0.06em] text-ink">$ 50.000</p>
          <div className="my-5 h-px bg-line" />
          <div className="grid grid-cols-2 gap-3 text-sm">
            <MiniField label="Categoría" value="Electrónica" />
            <MiniField label="Cuotas" value="Sin cuotas" />
          </div>
          <div className="mt-4 rounded-2xl bg-[linear-gradient(135deg,#0f766e,#2563eb)] p-5 text-white shadow-[0_12px_28px_rgba(15,118,110,0.24)]">
            <p className="text-xs font-semibold uppercase tracking-[0.14em] text-white/70">Precio sugerido</p>
            <p className="mt-1 text-3xl font-extrabold tracking-[-0.06em]">$ 63.619</p>
            <div className="mt-4 flex items-center gap-2 text-xs font-medium text-white/80"><CheckIcon /> Variables contempladas automáticamente</div>
          </div>
        </div>
      </div>
